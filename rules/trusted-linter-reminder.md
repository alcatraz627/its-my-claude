...
paths:
  ...
  # disclosed on demand, not always-on. Gist stays in rules/00-index.md; trigger is a literal system-reminder string; a hinter for that moment is proposed in the backlog.
