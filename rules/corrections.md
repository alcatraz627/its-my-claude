...
paths:
  ...
  # disclosed on demand, not always-on. Gist stays in rules/00-index.md; the atone-nudge hinter fires on corrections and routes to /atone, which owns the ritual.
