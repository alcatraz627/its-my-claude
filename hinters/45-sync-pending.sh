...
# emit a one-line hint asking Claude to apply the pending todos via TodoWrite,
...
printf '[sync-todos] %d pending workspace todo(s) — apply via TodoWrite at start of response, then delete %s:\n%s\n' \
